        ...
        <div class="row">
            ...
            <div class="col-xs-12 my-3 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" min="0" class="form-control" name="count" required>
                </div>
            </div>
            <div class="col-xs-12 my-3 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Цена:</strong>
                    <input min="0" placeholder="0" type="number" step="0.01" name="price" class="form-control" id="price" required>
                </div>
            </div>
            <div class="col-xs-12 my-3 col-sm-12 col-md-12">
                <div class="form-group">
